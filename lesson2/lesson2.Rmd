...
author: "Mike Curry and Karissa Whiting"
output:
  html_document:
    toc: yes
    toc_float: yes
...
gt::gt(demos2a, rowname_col = 'status') %>% 
      ...
      gt::tab_stubhead(label = "Status")
```

### Creating Table 1 and Summary tables

Often we have to create a 'table 1' or a summary of baseline characteristics of patients in R. `gtsummary` is a new package released on CRAN that allows for easy summarization of variables for table 1. This package was created by a statistician in our department Dan Sjoberg and many of us help contribute to it!

Here are two examples of how to use gtsummary for data summarization. 
